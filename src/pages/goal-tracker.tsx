...
const features = [
  {
    ...
    description:
      'Create structured running plans and objectives. Planthor helps you break big goals into trackable milestones so you always know where you stand.',
  },
  {
    title: '🏃 Sync Strava Activities',
    description:
      'Link your Strava account to automatically sync sport activities into your Planthor goal tracker dashboard — no manual logging needed.',
  },
  {
    title: '📊 Visualize Progress',
    description:
      'View your plan progress, completed activities, and remaining targets in a clean dashboard designed for athletes on the move.',
  },
  {
    title: '🤝 Share Achievements',
    description:
      'Post progress to the D2D social feed and celebrate milestones with a community that shares your "keep moving forward" mindset.',
  },
  {
    title: '🔓 100% Open Source',
    description:
      'Planthor is fully open-source. Inspect the code, contribute features, or self-host your own instance. No lock-in, no hidden fees.',
  },
  {
    title: '🌐 Community-First',
    description:
      'Built for the Dragging to Dream (D2D) community. Every feature is designed around the collective journey of athletes helping each other grow.',
  },
];

export default function GoalTrackerPage(): ReactNode {
  return (
    <Layout
      title="Planthor Goal Tracker – Track Your Goals & Running Plans"
      description="Planthor is a free, open-source goal tracker for athletes. Track running plans, sync with Strava, and share achievements with the Dragging to Dream (D2D) community.">
      <Head>
          ...
          <div className="container">
            ...
            <div className="row">
              {[
                ...
                <div key={item.step} className="col col--4" style={{ textAlign: 'center', marginBottom: '2rem' }}>
                  <div style={{
                    width: '3rem',
                    height: '3rem',
                    borderRadius: 0,
