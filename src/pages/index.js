        ...
        <div className="lp-nav-container">
          ...
          <div className="lp-nav-links">
            ...
            <div className="lp-nav-controls">
              <SearchBar />
              <ColorModeToggle value={colorMode} onChange={setColorMode} respectPrefersColorScheme={respectPrefersColorScheme}/>
            ...
            return (<a key={locale} href={targetPath} className={isCurrentLocale ? 'lp-locale-link active' : 'lp-locale-link'}>
                      {locale.toUpperCase()}
                    </a>);
        })}
              </div>
...
export default function Home() {
    return (<Layout noFooter wrapperClassName="custom-landing-page" title={translate({ message: 'Planthor – Dragging to Dream', id: 'homepage.title' })} description={translate({ message: 'Industrial-grade goal tracker for athletes who refuse to quit. Built for the persistence of the D2D community.', id: 'homepage.description' })}>
      <LandingPageContent />
    </Layout>);
}
